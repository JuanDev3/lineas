                    ...
                    <form id="formulario" class="p-3" action="<?=base_url?>admin/updatePerfil" method="POST">          
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4 col-12">
                                ...
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->emailUser : ''; ?>"/>
                            </div>
                            <div class="form-group col-md-4 col-12">
                                ...
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->claveUser : ''; ?>"/>						
                            </div>
                            <div class="form-group  col-md-4 col-12">
                                <label class="font-weight-bold" for="perfil">Perfil</label>                                      
                                <input disabled class="form-control" type="text" id="perfil" name="perfil"                          
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->perfilUser  : ''; ?>"/>	
                            </div>                            
                            <div class="form-group col-md-4 col-12">
