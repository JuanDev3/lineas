...
<script type="text/javascript">
    function activar(){
        document.getElementById('nomUsuario').disabled = false;
        document.getElementById('apeUsuario').disabled = false;
                ...
                <div class="card-body">
                    ...
                    <form id="formulario" class="p-3" action="<?=base_url?>admin/updatePerfil" method="POST">          
                        <div class="form-row">
                            ...
                            maxlength="50" value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->codUsuario: ''; ?>" />

                            <div class="form-group col-md-4 col-12">
                                <label class="font-weight-bold" for="email">Nombre</label>
                                <input disabled class="form-control" type="text" id="nomUsuario" name="nomUsuario" maxlength="45"                         
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->nomUsuario : ''; ?>"/>
                            </div>
                            <div class="form-group col-md-4 col-12">
                                <label class="font-weight-bold" for="email">Apellidos</label>
                                <input disabled class="form-control" type="text" id="apeUsuario" name="apeUsuario" maxlength="45"                         
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->apeUsuario : ''; ?>"/>
                            </div>
                            <div class="form-group col-md-4 col-12">
                                <label class="font-weight-bold" for="email">Email</label>
                                <input disabled class="form-control" type="email" id="email" name="email" maxlength="45"                         
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->email : ''; ?>"/>
                            </div>
                            <div class="form-group col-md-4 col-12">
                                ...
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->clave : ''; ?>"/>		 				
                            </div>
                            <div class="form-group col-md-4 col-12">
                                <label class="font-weight-bold" for="email">Institucion</label>
                                <input disabled class="form-control" type="text" id="institucion" name="institucion" maxlength="45"                         
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->institucion : ''; ?>"/>
                            </div>
                            <div class="form-group  col-md-4 col-12">
                                <label class="font-weight-bold" for="perfil">Perfil</label>                                      
                                <input disabled class="form-control" type="text" id="tipo" name="tipo"                          
                                value="<?=isset($dataUserPerfil) && is_object($dataUserPerfil) ? $dataUserPerfil->tipo  : ''; ?>"/>	
                            </div>                            
                            <div class="form-group col-md-4 col-12">
                                <label class="font-weight-bold" for="estado">Estado</label>
                                <select class="form-control" id="estado" name="estado" disabled>  
                                    <option value="1"<?=isset($dataUserPerfil) && is_object($dataUserPerfil) && $dataUserPerfil->estado == "1" ? 'selected' : '';?>>Activo</option>
                                    <option value="0"<?=isset($dataUserPerfil) && is_object($dataUserPerfil) && $dataUserPerfil->estado == "0" ? 'selected' : '';?>>Inactivo</option>                                        
                                </select>   						
                            </div>               
