...
class adminController{
    ...
    public function login(){
		...
		if ($userUser ==  TRUE){
		  ...
		  //el email existe 
			$usuario = new Admin(); 
			$dato = $usuario->loginModel("user","usuario='$user'");					
    ...
    public function dashboard(){  
		$admin = new Admin();
		$datoPub = $admin->totalPublics();
		$_SESSION["totalP"] = $datoPub['totalPublics'];

		$datoPost = $admin->totalPostulantes(); 
		$cantPostulantes = $datoPost['totalPostulante'];    
